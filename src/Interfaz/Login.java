...
public class Login extends javax.swing.JFrame {
    ...
    public void validarEntrada(String usuario, String contraseña) throws SQLException{
        String mensaje = Metodos_mysql.usuarioLogin(usuario,contraseña);
        if(mensaje.equals("Correcto")){
            Exito a = new Exito(null, true);
            a.titulo.setText("Bienvenido");
            a.ms.setText("");
            a.setVisible(true);
            try{
                conexion = Conexion_BD.conectar();
                String consulta = "SELECT tipo FROM usuarios WHERE usuario=? AND contraseña=?";
                ...
                if(resultado.next()){
                    ...
                    newframe.txtUsuario.setText(resultado.getString("tipo"));
                    this.dispose();
                }
                ...
                Error a = new Error(null, true);
                a.ms.setText("El usuario o contraseña son incorrectos");
                a.setVisible(true);
        }
    }
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/LOGIN/login2.jpg"))); // NOI18N
        bg.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 10, 170, 160));

        citybg.setBackground(new java.awt.Color(0, 134, 190));
        citybg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/LOGIN/login1.jpg"))); // NOI18N
        ...
        favicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/LOGIN/login3.png"))); // NOI18N
        favicon.setText("Doctolandia");
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        try {
            validarEntrada(userTxt.getText(),passTxt.getText());
        } catch (SQLException ex) {
