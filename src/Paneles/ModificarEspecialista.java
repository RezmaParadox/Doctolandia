 ...
 */
public final class ModificarEspecialista extends javax.swing.JPanel {
    ...
    public void validacion(){
        ...
        if(campo != "" && isNumeric == true){
            String mensaje=metodos.buscar_idEspecialista(txtid.getText());
    ...
    public void limpiar(){
        ...
        txtespecialidad.setForeground(new Color(153,153,153));
      ...
      public void recuperar_datos(String idEspecialista){
        try{
            conexion=Conexion_BD.conectar();
            String sql_busqueda="Select * FROM especialista WHERE idEspecialista=?";
            sentencia_preparada=conexion.prepareStatement(sql_busqueda);
            sentencia_preparada.setString(1,idEspecialista);
            resultado=sentencia_preparada.executeQuery();

            String sql_busqueda2="Select * FROM especialista_especializacion WHERE idEspecialista=?";
            ...
            String sql_busqueda3="Select * FROM especialista_telefono WHERE idEspecialista=?";
            ...
            String sql_busqueda4="Select * FROM especialista_correo WHERE idEspecialista=?";
            ...
            if(resultado.next()&&resultado2.next()&&resultado3.next()&&resultado4.next()){
                ...
                txtespecialidad.setText(resultado2.getString("especializacion"));
                txttelefono.setText(resultado3.getString("telefono"));
                txtcorreo.setText(resultado4.getString("correo"));
    ...
    private void initComponents() {
        ...
        validarEs = new javax.swing.JLabel();
        ...
        jLabel4.setText("Ingrese los datos del Especialista");
        ...
        panelModificar.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 198, 46));

        jLabel7.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel7.setText("Apellido Materno : ");
        panelModificar.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, 46));

        jLabel8.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel8.setText("Especialidad : ");
        panelModificar.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, 46));

        jLabel9.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel9.setText("Teléfono : ");
        panelModificar.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, -1, 46));

        jLabel10.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel10.setText("Correo : ");
        panelModificar.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, -1, 46));
        ...
        panelModificar.add(txtapePa, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, 294, 46));
        ...
        panelModificar.add(txtapeMa, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 294, 46));
        ...
        panelModificar.add(txtespecialidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 260, 294, 46));
        ...
        panelModificar.add(txttelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 340, 294, 46));
        ...
        panelModificar.add(txtcorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 420, 294, 46));

        jLabel11.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel11.setText("No. Casa : ");
        panelModificar.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 100, -1, 46));
        ...
        panelModificar.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 20, -1, 46));

        jLabel13.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel13.setText("Colonia : ");
        panelModificar.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 180, -1, 46));

        jLabel14.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel14.setText("Código Postal : ");
        panelModificar.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 260, -1, 46));

        jLabel15.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel15.setText("Ciudad : ");
        panelModificar.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 340, -1, 46));
        ...
        panelModificar.add(txtcp, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 260, 294, 46));
        ...
        panelModificar.add(txtno, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 100, 294, 46));
        ...
        panelModificar.add(txtcolonia, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 180, 294, 46));
        ...
        panelModificar.add(txtciudad, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 340, 294, 46));
        ...
        panelModificar.add(validarapePa, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 150, 290, 30));

        validarapeMa.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        validarapeMa.setForeground(new java.awt.Color(102, 0, 0));
        panelModificar.add(validarapeMa, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 290, 30));

        validarEs.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        validarEs.setForeground(new java.awt.Color(102, 0, 0));
        panelModificar.add(validarEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 310, 290, 30));

        validarTe.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        validarTe.setForeground(new java.awt.Color(102, 0, 0));
        panelModificar.add(validarTe, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 390, 290, 30));

        validarCo.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        validarCo.setForeground(new java.awt.Color(102, 0, 0));
        panelModificar.add(validarCo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 470, 290, 30));
        ...
        panelModificar.add(validarNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 150, 290, 30));

        validarCol.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        validarCol.setForeground(new java.awt.Color(102, 0, 0));
        panelModificar.add(validarCol, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 230, 290, 30));

        validarCP.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        validarCP.setForeground(new java.awt.Color(102, 0, 0));
        panelModificar.add(validarCP, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 310, 290, 30));

        validarCi.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        validarCi.setForeground(new java.awt.Color(102, 0, 0));
        panelModificar.add(validarCi, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 390, 290, 30));

        add(panelModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 1036, 510));
        ...
        add(panelOpciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 230, -1, -1));

        jLabel5.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel5.setText("Opciones");
        jLabel5.setToolTipText("");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 190, -1, -1));

        jLabel1.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel1.setText("Ingrese ID  para actualizar datos: ");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 96, -1, 46));
        ...
        add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 99, 294, 46));

        txtvalidar.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        add(txtvalidar, new org.netbeans.lib.awtextra.AbsoluteConstraints(681, 96, 380, 49));
    ...
    private void botonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActualizarActionPerformed
        // TODO add your handling code here:
        idEspecialista=Integer.parseInt(txtid.getText().trim());
        nombre=txtnombre.getText();
        apePa=txtapePa.getText();
        apeMa=txtapeMa.getText();
        especializacion=txtespecialidad.getText();
        ...
        metodos.modificar_especialista(nombre, apePa, apeMa, especializacion,
                                      telefono,correo,calle,numero,colonia,cp,
                                      ciudad,idEspecialista);
        txtid.setText("Ingrese el ID");
    ...
    private javax.swing.JLabel validarEs;
