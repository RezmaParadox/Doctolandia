 ...
 */
public final class EliminarEspecialista extends javax.swing.JPanel {
    ...
    public void recuperar_datos(String idEspecializacion){
        try{
            ...
            sentencia_preparada.setString(1,idEspecializacion);
            ...
            sentencia_preparada2.setString(1,idEspecializacion);
            ...
            sentencia_preparada3.setString(1,idEspecializacion);
            ...
            sentencia_preparada4.setString(1,idEspecializacion);
    ...
    public void preguntaEliminar(){
        ...
        a.ms.setText("¿Desea eliminar el Especialista?");
        a.id.setText(id);
        a.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Datos del Especialista");
        ...
        panelEliminacion.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, 46));

        jLabel6.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel6.setText("Apellido Paterno : ");
        panelEliminacion.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 198, 46));

        jLabel7.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel7.setText("Apellido Materno : ");
        panelEliminacion.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, 46));

        jLabel8.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel8.setText("Especialidad : ");
        panelEliminacion.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, 46));

        jLabel9.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel9.setText("Teléfono : ");
        panelEliminacion.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, -1, 46));

        jLabel10.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel10.setText("Correo : ");
        panelEliminacion.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, -1, 46));

        jLabel11.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel11.setText("No. Casa : ");
        panelEliminacion.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, -1, 46));

        jLabel12.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel12.setText("Calle : ");
        panelEliminacion.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 20, -1, 46));

        jLabel13.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel13.setText("Colonia : ");
        panelEliminacion.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, -1, 46));

        jLabel14.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel14.setText("Código Postal : ");
        panelEliminacion.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 260, -1, 46));

        jLabel15.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel15.setText("Ciudad : ");
        panelEliminacion.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 340, -1, 46));
        ...
        panelEliminacion.add(txttelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 340, 294, 46));
        ...
        panelEliminacion.add(txtnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 20, 294, 46));
        ...
        panelEliminacion.add(txtapePa, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, 294, 46));
        ...
        panelEliminacion.add(txtapeMat, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 294, 46));
        ...
        txtespecialidad.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txtespecialidad.setOpaque(true);
        panelEliminacion.add(txtespecialidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 260, 294, 46));
        ...
        panelEliminacion.add(txtcorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 420, 294, 46));
        ...
        panelEliminacion.add(txtciudad, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 340, 295, 46));
        ...
        panelEliminacion.add(txtcalle, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 20, 295, 46));
        ...
        panelEliminacion.add(txtno, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 100, 295, 46));
        ...
        panelEliminacion.add(txtcolonia, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 180, 295, 46));
        ...
        panelEliminacion.add(txtcp, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 260, 295, 46));

        add(panelEliminacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 1040, 500));
        ...
        add(panelOpciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 220, -1, -1));
        ...
        add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 100, 294, 46));

        txtvalidar.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        add(txtvalidar, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 100, 294, 49));
