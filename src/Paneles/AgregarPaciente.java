 ...
 */
public final class AgregarPaciente extends javax.swing.JPanel {
    ...
    public void validacion(){
        ...
        if(campo != "" && isNumeric == true){
            String mensaje=metodos.buscar_idPaciente(txtid.getText());
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Ingrese los datos del Paciente");
        ...
        jPanel1.add(txtvalidar, new org.netbeans.lib.awtextra.AbsoluteConstraints(76, 91, 470, 33));
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        // TODO add your handling code here:
        idPaciente=Integer.parseInt(txtid.getText().trim());
        ...
        metodos.agregar_paciente(idPaciente,nombre, apePa, apeMa,
