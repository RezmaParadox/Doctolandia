...
public class ConsultaPaciente extends javax.swing.JPanel {
    ...
    String [] columnas ={"idPaciente","Nombre","Apellido Paterno","Apeliido Materno",
    ...
    public void cargarTabla(){
        ...
        try{
            ...
            String consulta1="SELECT * FROM paciente";
            String consulta2="SELECT * FROM paciente_telefono";
            String consulta3="SELECT * FROM paciente_correo";
    ...
    public void busquedaFiltrada(String tipo, String id){
        ...
        if(tipo.equals("idEmpleado")){
            try{
                conexion=Conexion_BD.conectar();
                String consulta1="SELECT * FROM paciente WHERE idPaciente LIKE " 
                              + '"' + id + "%" + '"';
                String consulta2="SELECT * FROM paciente_telefono WHERE idPaciente LIKE " 
                              + '"' + id + "%" + '"';
                String consulta3="SELECT * FROM paciente_correo WHERE idPaciente LIKE " 
                              + '"' + id + "%" + '"';
                sentencia_preparada1=conexion.prepareStatement(consulta1);
                sentencia_preparada2=conexion.prepareStatement(consulta2);
                sentencia_preparada3=conexion.prepareStatement(consulta3);
        ...
        if(tipo.equals("Nombre")){
            try{
                conexion=Conexion_BD.conectar();
                String consulta1="SELECT paciente.idPaciente,paciente.nombre,paciente.apePa, "
                                  + "paciente.apeMa, paciente.calle,paciente.numero,paciente.colonia, "
                                  + "paciente.cp,paciente.ciudad,paciente_telefono.telefono, paciente_correo.correo "
                                  + "FROM paciente, paciente_telefono, paciente_correo "
                                  + "WHERE paciente.nombre LIKE "
                                  + '"' + id + "%" + '"'
                                  + "AND paciente_telefono.idPaciente=paciente.idPaciente "
                                  + "AND paciente_correo.idPaciente=paciente.idPaciente";
        ...
        if(tipo.equals("Teléfono")){
            try{
                ...
                String consulta1="SELECT paciente.idPaciente,paciente.nombre,paciente.apePa, "
                                  ...
                                  + "paciente.cp, paciente.ciudad, paciente_telefono.telefono, paciente_correo.correo "
                                  + "FROM paciente, paciente_telefono, paciente_correo "
                                  + "WHERE paciente_telefono.telefono LIKE "
                                  + '"' + id + "%" + '"'
                                  + "AND paciente_telefono.idPaciente=paciente.idPaciente "
                                  + "AND paciente_correo.idPaciente=paciente.idPaciente";
                sentencia_preparada1=conexion.prepareStatement(consulta1);
        ...
        if(tipo.equals("Correo")){
            try{
                ...
                String consulta1="SELECT paciente.idPaciente,paciente.nombre,paciente.apePa, "
                                  ...
                                  + "paciente.cp, paciente.ciudad, paciente_telefono.telefono, paciente_correo.correo "
                                  + "FROM paciente, paciente_telefono, paciente_correo "
                                  + "WHERE paciente_correo.correo LIKE "
                                  + '"' + id + "%" + '"'
                                  + "AND paciente_telefono.idPaciente=paciente.idPaciente "
                                  + "AND paciente_correo.idPaciente=paciente.idPaciente";
                sentencia_preparada1=conexion.prepareStatement(consulta1);
    ...
    private void initComponents() {
        ...
        add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 125, 499, 52));
        ...
        datos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "idPaciente", "Nombre", "Apellido Paterno", "Apellido Materno", "Teléfono", "Correo", "Calle", "Número", "Colonia", "C.P.", "Ciudad"
            }
        ));
        ...
        add(txtvalidar, new org.netbeans.lib.awtextra.AbsoluteConstraints(729, 125, 299, 52));
        ...
        add(txtTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, -1, 50));
